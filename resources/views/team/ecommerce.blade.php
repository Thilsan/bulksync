{{--
    The e-commerce department's chart, as transcribed from the work
    distribution sheet. It lives in its own file because the page around
    it now carries a tab per department, and the next chart anyone writes
    down should be a file beside this one rather than another branch.
--}}
@php
/*
...
<div class="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
    <div class="flex flex-wrap items-center justify-between gap-4 border-b border-gray-100 px-5 py-4">
        <div>
            ...
            {{-- He owns the sheet rather than a column of it, so he is named
                 here and is not one of the people the matrix checks off. --}}
            <p class="mt-2 inline-flex items-center gap-1.5 text-xs">
                <span class="grid h-5 w-5 place-items-center rounded-full bg-brand-100 text-[9px] font-bold text-brand-800">
                    {{ $initials('Shahid Raufi') }}
                </span>
                <span class="text-gray-500">Head of Department</span>
                <span class="font-semibold text-gray-900">Shahid Raufi</span>
            </p>
        </div>
