@php
    $tiles = [
        ...
        ['key' => 'waiting_mapping',    'label' => 'Waiting for Mapping', 'hint' => 'With Supply Chain',   'value' => $stats['waiting_mapping'],    'tone' => 'text-orange-600 bg-orange-50',    'filter' => \App\Models\ProductRequest::WAITING_MAPPING, 'icon' => 'M4 4h16M6 4v5a6 6 0 006 6 6 6 0 006-6V4M6 20v-5a6 6 0 016-6 6 6 0 016 6v5M4 20h16'],
        ...
        ['key' => 'ready_for_upload',   'label' => 'Ready for Upload',    'hint' => 'Ready to publish',    'value' => $stats['ready_for_upload'],   'tone' => 'text-teal-600 bg-teal-50',        'filter' => \App\Models\ProductRequest::READY_FOR_UPLOAD,'icon' => 'M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12'],
        ['key' => 'published',          'label' => 'Published',           'hint' => 'Live on website',     'value' => $stats['published'],          'tone' => 'text-emerald-600 bg-emerald-50',  'filter' => \App\Models\ProductRequest::PUBLISHED,       'icon' => 'M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9'],
        ['key' => 'completed',          'label' => 'Completed',           'hint' => 'Successfully closed', 'value' => $stats['completed'],          'tone' => 'text-green-600 bg-green-50',      'filter' => \App\Models\ProductRequest::COMPLETED,       'icon' => 'M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z'],
    ];
@endphp
